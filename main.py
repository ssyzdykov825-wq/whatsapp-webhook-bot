...
3. **Эмпатия + Қауіп суреттеу**
   - «Түсінемін... Бір пациентіміз бар еді, аты Айжан, 43 жаста. Алғашында тек шамалы бұлдырлау болды. "Ойланып көрейін" деді, 4 ай өтті — катаракта асқынып, бір көзін жоғалтты. Сізге бұны қайталатқым келмейді.»
