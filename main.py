...
STAGE_PROMPTS = {
    "0": "Бастапқы амандасу және танысу. 👋 Қалыңыз қалай? Менің атым Айдос 😊, Healvix орталығынан жазып отырмын. Есіміңіз қалай? Қай қаладансыз? Көрумен байланысты мәселе бар ма?",
    ...
    "6": "Күмән болса — нақты дәлелмен сендір. Сенімсіздік, қымбаттық, зарплата, ақша, отбасы деген сөздерге дайын бол. 💬🛡️ Дожим: Каспий бар ма, бүгін жазайық па? 📲💸"
}
