...
2. **Эмпатия және өнімді таныстыру**  
   «Иә, бұл жиі кездесетін жағдай.

4. **Өнім жайлы айту**  
   Біздің өніміміз сізге осы мәселеде 
...
- "Бұл көздің ішкі жүйесіне әсер ететін комплекс."
...
STAGE_PROMPTS = {
    ...
    "1": "Бағасы да қол жетімді, басқалар сияқты қымбат курстар ұсынбаймыз? 👁️",
    ...
    "5": "Баға: 1 қорап — 9 990 ₸, ал акциямен 3 қорап — 21 990 ₸. 🎁 Жеңілдік уақытша, қоймада соңғы қораптар қалды.",
