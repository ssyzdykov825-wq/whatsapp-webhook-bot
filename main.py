...
# 1. Истории для ротации
STORY_ROTATION = [
    "Жақында бір кісі жазды — 40 жаста, көзі бұлдырлай бастаған. Алғашында мән бермепті, 3 айдан кейін катаракта басталған. Біздің өніммен 2 айда көзі қалыпқа келе бастады. Сондықтан ерте қолға алған дұрыс екен.",
    "Жақында бізге 45 жастағы апай жазды. Көзі бұлдырлап кеткен. Дәрігер операция керек деген. Бірақ Healvix қабылдап, 2 айда көру қабілеті жақсарды.",
    "Бір кісі болды, 50 жаста, көзі бұлдырап көретін — сол кісі де бастағанда сенімсіз болған. Бірақ 3 аптадан кейін өзі рахметін айтты."
]

# 2. Выбор случайной истории
random_story = random.choice(STORY_ROTATION)
...
4. Жақында бір кісі жазды — 40 жаста, көзі бұлдырлай бастаған. Алғашында мән бермепті, 3 айдан кейін катаракта басталған. Біздің өніммен 2 айда көзі қалыпқа келе бастады. Сондықтан ерте қолға алған дұрыс екен.

5. **Healvix өнімін таныстыру**  
...
7. **Күмәнмен жұмыс (қымбат, сенімсіздік, отбасы, ақша)**  
...
STAGE_PROMPTS = {
    ...
    "3": f"Көз — өте нәзік мүше. Егер уақытында қолға алмасаңыз, асқынып операцияға апаруы мүмкін. Бұл жағдай көру сапасына әсер етеді. ⚠️ {random.choice(STORYTELLING_VARIANTS)}",
