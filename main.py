...
# Объяви список историй ДО использования
STORYTELLING_VARIANTS = [
    ...
    "Кеше апай жазды — көзінде бұлдырлау басталыпты, 2 ай бойы компьютер алдында көп отырған. Алғашында каплямен емдеп көрген, бірақ уақыт өте нәтиже болмаған. Healvix қабылдағалы көзінің шаршауы кетті дейді.",
    "Бір жігіт жазды — 35 жаста, жүргізуші. Түнде көлік жүргізу қиындапты, фарлар көзін шағылыстырып, көру қиындаған. Екі айдан бері Healvix қабылдап, енді бұрынғыдай көреді екен.",
]

# Выбери случайную историю
selected_story = random.choice(STORYTELLING_VARIANTS)
